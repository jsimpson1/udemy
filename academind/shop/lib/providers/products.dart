...
class Products with ChangeNotifier {
  List<Product> _items = [
    ...
    Product(
      ...
      imageUrl: 'assets/images/512px-Trousers,_dress_(AM_1960.022-8).jpg',
    ),
    Product(
      id: 'p3',
      title: 'Yellow Scarf',
      ...
      imageUrl: 'assets/images/4438260868_cc79b3369d_z.jpg',
    ),
    Product(
      id: 'p4',
      title: 'A Pan',
      ...
      imageUrl: 'assets/images/1024px-Cast-Iron-Pan.jpg',
    ),
  ];
  ...
  List<Product> get items {
    ...
    // }
    // use of brackets and spreader ie (...) returns separate list of items rather than the core item
    return [..._items];
  }
